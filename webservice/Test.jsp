...
function accessAppletResult()
{
 ...
 //   document.getElementById('showProperty').value = fn;
    ...
    var Yaxis = "Y-axis";
    Yaxis = document.applets[0].getYaxis();
    document.getElementById('Y-axis').innerHTML = fn;
...
<td><input type="hidden" name="showFilePath" id='showFilePath'  value='<%=showFilePath %>' size="50"/></td>
 ...
 <tr>
 <td><div id="TestResult" align="center" valign="middle">Show test results below:</div></td>
</tr>

 <tr>
 <td><div id="Y-axis" align="center" valign="middle">Show Y-axis below:</div></td>
</tr>
