...
<!--							<tr><td><table width="700" align="left" valign="left" >
 ...
 -->										<tr><td><h3>Test COX using local data</h3></td></tr>
<%
...
<tr><td>To compare between features, input feature name below. Otherwise, input 0.</td><tr>
<tr><td>(Delay may happen when comparing between >50 records.)</td><tr>
<tr><form>
<td><div>Input 1 feature to compare: <input type="text" name="feature" id="feature"></div></td>
<td><div>Input cutoff of the feature: <input type="text" name="cutoff" id="cutoff"></div></td>
</form></tr>
<tr><td>
<applet code="cox.LocalTestApplet2.class" archive="WebCox.jar" width=500 height=72" MAYSCRIPT>
...
<param name="feature_compare" value=#feature.val()>
<param name="cutoff" value=#cutoff.val()>
</applet>
</td>
</tr>
</table>
...
{
	//var fn = "TestResult";
	var check = document.applets[0].getfeature();
	var check2 = document.applets[0].getcutoff();
